...
public class MenuReservation  extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar_reserv);
        ...
        tabLayout = (TabLayout) findViewById(R.id.tabLayout_reserv);
        tabLayout.addTab(tabLayout.newTab().setText("선상낚시"));
        tabLayout.addTab(tabLayout.newTab().setText("좌대낚시"));
        tabLayout.addTab(tabLayout.newTab().setText("강"));
